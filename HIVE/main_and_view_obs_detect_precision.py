...
# set camera specs
wp = 640
theta_fov_depth = math.radians(79)
        ...
        while datapoints_recorded < num_datapoints:
            ...
            if markers_list: # check to see if markers contains any elements (not empty)
                ...
                try:
                    ...
                    # es = 1
                    # phi_l_error = ((obstacle_yaw_bounds[0] - phi_l_T)/phi_l_T)**es*100
                    # phi_r_error = ((obstacle_yaw_bounds[1] - phi_r_T)/phi_r_T)**es*100
                    # f_error = ((face_size - f_T)/f_T)**es*100
                    # d_l_error = ((dist_left - d_l_T)/d_l_T)**es*100
                    # d_r_error = ((dist_right - d_r_T)/d_r_T)**es*100
            ...
            print("{phi_l_T:6.2f}, {phi_r_T:6.2f}, {f_T:6.2f}, {d_l_T:6.2f}, {d_r_T:6.2f}, "
                "{phi_l:8.2f}, {phi_r:6.2f}, {face_size:5.2f}, {dist_left:6.2f}, {dist_right:6.2f}, "
                "{phi_le:8.2f}, {phi_re:6.2f}, {fe:6.2f}, {d_le:6.2f}, {d_re:6.2f}".format(
                phi_l_T = phi_l_T,
                phi_r_T = phi_r_T,
                f_T = f_T,
                d_l_T = d_l_T,
